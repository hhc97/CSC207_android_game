...
public class Level1Activity extends GameManager {
  ...
  private void setActivityLevel(){
    ...
    if (DayOrNight == 0)
      activityLevel = R.layout.n_activity_level1;
    else if (DayOrNight == 1)
      activityLevel = R.layout.activity_level1;
  }
  ...
  private void heroStandAnimation(){hero.setImageResource(heroAction[0]);}
  private void heroWalkAnimation(){hero.setImageResource(heroAction[1]);}
  private void heroHurtAnimation(){hero.setImageResource(heroAction[2]);}
  private void heroAttackAnimation(){hero.setImageResource(heroAction[3]);}
  private void heroFacingLeft(){hero.setScaleX(-1f);}
  private void heroFacingRight(){hero.setScaleX(1f);}

  private void enemyStandAnimation(){enemy.setImageResource(enemyAction[0]);}
  private void enemyWalkAnimation(){enemy.setImageResource(enemyAction[1]);}
  private void enemyHurtAnimation(){enemy.setImageResource(enemyAction[2]);}
  private void enemyAttackAnimation(){enemy.setImageResource(enemyAction[3]);}
  private void enemyFacingLeft(){enemy.setScaleX(-1f);}
  private void enemyFacingRight(){enemy.setScaleX(1f);}

  private void imageInvisable(GifImageView image){image.setVisibility(View.INVISIBLE);}
